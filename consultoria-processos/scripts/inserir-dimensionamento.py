...
"""
Insere o conteudo de dimensionamento.json no placeholder
##INSIRA_CONTEUDO_dimensionamento.json## em WORK_DIR\\html\\Analise.html.
...
MARCADOR = "##INSIRA_CONTEUDO_dimensionamento.json##"
ENCODINGS = ("utf-8-sig", "utf-8", "cp1252", "latin-1")


def resolver_work_dir():
    if len(sys.argv) < 2:
        raise ValueError("Uso: python inserir-dimensionamento.py <WORK_DIR>")
...
def main():
    ...
    json_path = work_dir / "dimensionamento" / "dimensionamento.json"
    ...
    print(f"dimensionamento.json inserido em: {html_path}")
