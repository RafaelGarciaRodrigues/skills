...
"""
Insere o conteudo de convergir.json no placeholder
##INSIRA_CONTEUDO_convergencia.json## em WORK_DIR\\html\\Analise.html.
...
MARCADOR = "##INSIRA_CONTEUDO_convergencia.json##"
ENCODINGS = ("utf-8-sig", "utf-8", "cp1252", "latin-1")


def resolver_work_dir():
    if len(sys.argv) < 2:
        raise ValueError("Uso: python inserir-convergencia.py <WORK_DIR>")
...
def main():
    ...
    json_path = work_dir / "convergir" / "convergir.json"
    ...
    print(f"convergir.json inserido em: {html_path}")
